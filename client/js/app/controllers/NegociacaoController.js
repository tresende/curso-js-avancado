                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function adiciona(event) {
                        ...
                        this._service.cadastra(negociacao).then(function (mensagem) {
                            _this2._mensagem.texto = 'Negoçiação Adicionada';
                    ...
                    value: function importaNegociacoes() {
                        ...
                        Promise.all([this._service.obterNegociacoesDaSemana(), this._service.obterNegociacoesDaSemanaAnterior(), this._service.obterNegociacoesDaSemanaRetrasada()]).then(function (negociacoes) {
